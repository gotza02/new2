...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/yBh1ZaSVDsdgDdgHDddDgdgdhSGsdGbWseMP/v3.0lts/main/izin | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/yBh1ZaSVDsdgDdgHDddDgdgdhSGsdGbWseMP/v3.0lts/main/izin | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"ORDER SC","url":"wa.me/6282306188666"},{"text":"WHATSAPP GROUP","url":"https://chat.whatsapp.com/FJnnnk29PwK8XpssKvGc6v"}]]}'
...
echo -e "  Recode By Elvaretta Store  ©  LAMPUNG 2024"
echo -e "  since 2023"
echo -e "${YELLOW}==========================================================${NC}"
echo ""
sleep 2
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/yBh1ZaSVDsdgDdgHDddDgdgdhSGsdGbWseMP/v3.0lts/main/izin | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/yBh1ZaSVDsdgDdgHDddDgdgdhSGsdGbWseMP/v3.0lts/main/izin | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/yBh1ZaSVDsdgDdgHDddDgdgdhSGsdGbWseMP/v3.0lts/main/izin | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
echo -e "   ------------------------------------"
read -p "   Pilih 1 untuk melanjutkan Instalasi : " host
echo ""
if [[ $host == "1" ]]; then
echo -e "   \e[1;32mInput Subdomain Kamu $NC"
...
wget raw.githubusercontent.com/yBh1ZaSVDsdgDdgHDddDgdgdhSGsdGbWseMP/v3.0lts/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
